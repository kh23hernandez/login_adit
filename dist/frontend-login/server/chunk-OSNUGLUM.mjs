...
var LoginComponent = class _LoginComponent {
  ...
  onLogin() {
    ...
    this.http.post("http://3.23.112.121:3000/api/auth/login", loginData).subscribe((response) => {
      const token = response.token;
      if (token && token.length > 0) {
        localStorage.setItem("token", token);
        this.router.navigateByUrl("/home");
      } else {
        this.errorMessage = "Token inv\xE1lido recibido.";
      }
    }, (error) => {
      if (error.status === 401) {
        this.errorMessage = "Credenciales incorrectas. Por favor, int\xE9ntalo de nuevo.";
      } else {
        this.errorMessage = "Error al iniciar sesi\xF3n. Por favor, verifica tus credenciales.";
      }
      console.error("Login failed", error);
    });
  }
  static \u0275fac = function LoginComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _LoginComponent)(\u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(HttpClient), \u0275\u0275directiveInject(Router));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LoginComponent, selectors: [["app-login"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 6, vars: 2, consts: [[3, "ngSubmit", "formGroup"], ["formControlName", "username", "placeholder", "Nombre de usuario"], ["type", "password", "formControlName", "password", "placeholder", "Contrase\xF1a"], ["type", "submit"], ["class", "error", 4, "ngIf"], [1, "error"]], template: function LoginComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275template(5, LoginComponent_div_5_Template, 2, 1, "div", 4);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
  ...
  }, dependencies: [CommonModule, NgIf, ReactiveFormsModule, \u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName, HttpClientModule, FormsModule], styles: ["\n\n.login-container[_ngcontent-%COMP%] {\n  max-width: 400px;\n  margin: 0 auto;\n  padding: 20px;\n  border: 1px solid #ccc;\n  border-radius: 5px;\n}\nh2[_ngcontent-%COMP%] {\n  text-align: center;\n  margin-bottom: 20px;\n}\nlabel[_ngcontent-%COMP%] {\n  display: block;\n  margin-top: 10px;\n}\ninput[_ngcontent-%COMP%] {\n  width: 100%;\n  padding: 8px;\n  margin-top: 5px;\n  box-sizing: border-box;\n}\nbutton[_ngcontent-%COMP%] {\n  width: 100%;\n  padding: 10px;\n  margin-top: 20px;\n  background-color: #007bff;\n  color: white;\n  border: none;\n  border-radius: 5px;\n  cursor: pointer;\n}\nbutton[_ngcontent-%COMP%]:hover {\n  background-color: #0056b3;\n}\n/*# sourceMappingURL=login.component.css.map */"] });
};
(() => {
...
var HomeComponent = class _HomeComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HomeComponent, selectors: [["app-home"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 7, vars: 0, consts: [[1, "sidebar"], [3, "click"]], template: function HomeComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "aside", 0)(1, "h2");
      \u0275\u0275text(2, "Men\xFA");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(3, "ul")(4, "li")(5, "a", 1);
      \u0275\u0275listener("click", function HomeComponent_Template_a_click_5_listener() {
        return ctx.logout();
      });
      \u0275\u0275text(6, "Salir");
      \u0275\u0275elementEnd()()()();
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-OSNUGLUM.mjs.map
